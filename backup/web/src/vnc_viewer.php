<?php
/**
 * Page VNC plein écran autonome avec le nom du client dans le titre
 */
session_start();
...
<body>
    <div class="vnc-header">
        <div class="vnc-title">
            ...
            <span><strong><?= htmlspecialchars($clientName) ?></strong></span>
        ...
        <div class="vnc-actions">
            ...
            <button class="vnc-btn" onclick="window.close()" title="Fermer cette fenêtre">
                <span>✕</span> Fermer
            </button>
        </div>
    </div>
