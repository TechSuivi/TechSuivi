...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($pdo)) {
    ...
    if ($current_intervention && $current_intervention['en_cours'] == 0) {
        $message = '<p style="color: red;">Cette intervention est clôturée et ne peut plus être modifiée.</p>';
    } else {
...
<style>
/* Modern styles for interventions edit page */
.intervention-page {
...
.nettoyage-item input[type="text"] {
    flex: 1;
    padding: 8px 12px;
    border: 2px solid var(--border-color);
    border-radius: 8px;
...
/* Amélioration du mode sombre pour la section nettoyage */
body.dark .nettoyage-item {
    background-color: #2b2b2b !important;
    border-color: #555 !important;
    color: #fff !important;
}

body.dark .nettoyage-item input[type="text"] {
    background-color: #1a1a1a !important;
    border-color: #555 !important;
    color: #fff !important;
}

body.dark .nettoyage-item label {
    color: #fff !important;
}
...
body.dark #statut_id option {
    background-color: #1a1a1a !important;
    color: #fff !important;
}

/* Styles pour l'historique des statuts en mode sombre */
body.dark .historique-statuts-container {
    background-color: #2b2b2b !important;
    border-color: #555 !important;
}

body.dark .historique-statuts-container h4 {
    color: #3498db !important;
}

body.dark .historique-entry {
    background-color: transparent !important;
    border-bottom-color: #555 !important;
}

body.dark .historique-entry strong {
    color: #fff !important;
}

body.dark .historique-entry small {
    color: #aaa !important;
}

body.dark .historique-entry .badge-actuel {
    background-color: #28a745 !important;
    color: white !important;
}

body.dark .historique-info-container {
    background-color: #1a3a5c !important;
    border-color: #3498db !important;
}

body.dark .historique-info-container h4 {
    color: #3498db !important;
}

body.dark .historique-info-container p {
    color: #ccc !important;
}

body.dark .historique-info-container small {
    color: #aaa !important;
}

body.dark .historique-info-container a {
    color: #3498db !important;
}

/* Indicateur visuel pour le statut sélectionné */
#statut_id {
    position: relative;
}
